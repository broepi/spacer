...
clean :
	-rm build/*
build/spacer : build/display.o build/sprite.o build/starfield.o build/radar.o build/font.o build/spacer.o build/image.o build/playership.o build/mob.o build/camera.o build/cloud.o build/utils.o
	g++ -o build/spacer build/display.o build/sprite.o build/starfield.o build/radar.o build/font.o build/spacer.o build/image.o build/playership.o build/mob.o build/camera.o build/cloud.o build/utils.o -lSDL2 -lSDL2_image -lSDL2_ttf
...
build/radar.o : src/radar.cpp src/radar.h src/sprite.h src/drawable.h
...
build/spacer.o : src/spacer.cpp src/spacer.h src/display.h src/image.h src/font.h src/camera.h src/starfield.h src/drawable.h src/playership.h src/mob.h src/sprite.h src/drawable.h src/cloud.h src/mob.h src/sprite.h src/drawable.h src/utils.h
