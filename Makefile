...
clean :
	-rm -R build/*.*
	-rm -R build/*/*.*	
build/spacer : build/framework/display.o build/framework/sprite.o build/framework/vector2d.o build/framework/rgba.o build/framework/font.o build/framework/rect.o build/framework/image.o build/framework/game.o build/framework/label.o build/framework/mixer.o build/framework/sound.o build/framework/mob.o build/framework/camera.o build/framework/utils.o build/starfield.o build/radar.o build/spacer.o build/enemyship.o build/playership.o build/cloud.o
	g++ -o build/spacer build/framework/display.o build/framework/sprite.o build/framework/vector2d.o build/framework/rgba.o build/framework/font.o build/framework/rect.o build/framework/image.o build/framework/game.o build/framework/label.o build/framework/mixer.o build/framework/sound.o build/framework/mob.o build/framework/camera.o build/framework/utils.o build/starfield.o build/radar.o build/spacer.o build/enemyship.o build/playership.o build/cloud.o -lSDL2 -lSDL2_image -lSDL2_ttf
...
build/framework/game.o : build/ src/framework/game.cpp src/framework/game.h src/framework/display.h src/framework/vector2d.h
...
build/spacer.o : build/ src/spacer.cpp src/spacer.h src/framework/game.h
	g++ -o build/spacer.o -c src/spacer.cpp $(shell freetype-config  --cflags) -Wno-write-strings
build/enemyship.o : build/ src/enemyship.cpp src/enemyship.h src/framework/mob.h src/framework/sprite.h src/framework/drawable.h src/framework/vector2d.h src/framework/vector2d.h src/spacer.h src/framework/game.h src/framework/utils.h src/framework/image.h src/framework/drawable.h src/framework/vector2d.h
	g++ -o build/enemyship.o -c src/enemyship.cpp $(shell freetype-config  --cflags) -Wno-write-strings
build/playership.o : build/ src/playership.cpp src/spacer.h src/framework/game.h src/playership.h src/framework/mob.h src/framework/sprite.h src/framework/drawable.h src/framework/vector2d.h src/framework/vector2d.h src/spacer.h src/framework/game.h src/framework/utils.h src/framework/image.h src/framework/drawable.h src/framework/vector2d.h
